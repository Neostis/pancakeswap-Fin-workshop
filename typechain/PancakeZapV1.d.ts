...
interface PancakeZapV1Interface extends ethers.utils.Interface {
  functions: {
...
export type AdminTokenRecoveryEvent = TypedEvent<
  [string, BigNumber] & { tokenAddress: string; amountTokens: BigNumber }
>;

export type NewMaxZapReverseRatioEvent = TypedEvent<
  [BigNumber] & { maxZapReverseRatio: BigNumber }
>;
...
export class PancakeZapV1 extends BaseContract {
  ...
  filters: {
    ...
    ): TypedEventFilter<[BigNumber], { maxZapReverseRatio: BigNumber }>;
